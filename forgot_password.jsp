			...
			<section class="container-md wrapper align-content-center">
				<div class="row">
					...
					<div class="col-xxl-5 col-xl-5 col-lg-6 col-md-7 col-sm-11 col-11" id="form_part">
						...
						<form action="forgot_password.do" method="post" id="register_form">
							<div class="form-row mt-4">
								<div class="col">
									<div class="d-inline-block align-items-center input_box" style="width: 90%"> 
										<i class="fas fa-envelope form_icons"></i> 
										
										<input class="input" type="email" name="forgot_email" placeholder="Enter Your Email Address" autocomplete="off" style="width: 85%; font-size: 17px;">
									</div>
								</div>
							</div>
							<div class="mt-2">
								<label style="color:#666;">
									we will send a Verification link your Email to verify your Email
								</label>
							</div>
							<div class="row">
								<div class="col">
									<div class="g-recaptcha mt-4" data-sitekey="6LdxBaMaAAAAABOAOFStgwkh_2wYw6vxGyTsPmGy" id="g_captcha_response">
									</div>
								</div>
							</div>
							<div class="row">
