				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xxl-9 col-xl-8 col-lg-8 col-md-7 pic_view">
							<div>
								<a href="user_profile.do" class="fa fa-arrow-left back_btn mt-3 ml-2 py-1 px-2"></a>
								<div class="img_view">
						...
						<div class="col-xxl-3 col-xl-4 col-lg-4 col-md-5 comments_view">
							<div class="mt-2 clearfix pb-2" style="border-bottom: 1px solid #aaa;">
								<img src="show_profile_pic.do" class="post_user_img">
								<h6 class="post_user_name d-inline-block">
									${user.userName}
								</h6>
								<br>
								<br>
							...
							<input type="hidden" value="${user.userId}" id="oth_users_id">
							...
							<div class="post_comment pt-2">
								<form id="form">
									...
									<textarea class="d-inline-block mx-0" 
									name="comment" id="comment_field">
									</textarea>
