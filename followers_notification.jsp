					...
					<div class="row">
						...
						<div class="col-10 col-lg-7 main_body">
							...
							<div class="mt-3 icons_container">
								...
								<div class="fa-2x px-md-3 px-2 py-2 d-inline-block">
									<a href="followers_notification.do" class="fa fa-user nav_icons nav_icons_active" aria-hidden="true"></a>
							...
							<div class="notification_container my-3">
								<c:choose>
									<c:when test="${empty followers_notifications}">
									...
									<c:otherwise>
										<c:forEach var="notify" items="${followers_notifications}">
											...
											py-2">
												<a href="sg_user_view.do?user_id=${notify.sendUserId}" class="text-decoration-none" style="color: #555">
													<span class="send_user_pro_pic_cont">

													</span>
													
													<span class="notify_txt pl-1 pr-3 py-2">
														${notify.followersNotificationMsg}
													</span>
													<br><br>
													<span class="mr-3 px-2 py-1 notify_times">
														${itech:dateformat(notify.followersNotificationTime)}
													</span>
