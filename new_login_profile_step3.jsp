			...
			<section class="container wrapper align-content-center my-5">
				<div class="row">
					...
					<div class="col-md-7 profile_pic_part">
						<img src="show_profile_pic.do" class="img-fluid ml-5 mt-5 mb-5">
					</div>
					<!-- SVG Part end -->

					<!-- Form Part -->
					<div class="col-md-5 mt-5" id="form_part">
						<h4 class="mt-3 mb-3 d-inline-block">Write Your Profile Bio</h4>
						<br>
						
						<form action="new_account_bio.do" method="post" id="register_form">
							<div class="form-row mt-3">
								<div class="col">
									<div class="d-inline-block align-items-center input_box" style="width: 80%"> 
										<div id="text_area_container">
											<textarea name="account_bio" placeholder="Write Something...">
							...
							<div class="row">
								<div class="col">
									<a href="save_address.do" class="skip mt-3 float-left">
										Skip
									</a>
