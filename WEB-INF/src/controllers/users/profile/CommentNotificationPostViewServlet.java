...
public class CommentNotificationPostViewServlet extends HttpServlet{
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException{
		...
		if(user!=null){
			...
			request.getRequestDispatcher("comments_notification_post_view.jsp").forward(request,response);
