					...
					<div class="row">
						...
						<div class="col-10 col-lg-7 main_body">
							...
							<div class="mt-3 icons_container">
								...
								<div class="fa-2x px-md-3 px-2 py-2 d-inline-block">
									<a href="like_notification.do" class="fa fa-heart-o nav_icons d-inline-block " aria-hidden="true"></a>
								...
								<div class="fa-2x px-md-3 px-2 py-2 d-inline-block">
									<a href="comment_notification.do" class="fa fa-comments nav_icons nav_icons_active" aria-hidden="true"></a>
									<span id="comments_count" class="d-inline-block notify_count" 
									style="font-size: 10px;"></span>
								</div>
							</div>
							<div class="notification_container my-2">
								<c:choose>
									<c:when test="${empty comment_notifications}">
									...
									<c:otherwise>
										<c:forEach var="notify" items="${comment_notifications}">
											...
											py-2">
												<a href="
												comments_notification_post_view.do?post_id=${notify.userPost.userPostId}&user_id=${notify.user.userId}" class="text-decoration-none" style="color: #555
												">
													<span class="send_user_pro_pic_cont">

													</span>
													<span class="notify_txt pl-1 pr-3 py-2">
														${notify.commentsNotificationMsg}
													</span>
													<br><br>
													<span class="mr-3 px-2 py-1 notify_times">
														${itech:dateformat(notify.commentsNotificationTime)}
													</span>
